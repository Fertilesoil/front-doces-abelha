...
const BotaoFormulario = ({ funcao, produto, loader }) => {
  return (
    <button
    className={`px-5 py-1.5 bg-orange-500 text-white rounded-md font-[500] flex items-center hover:scale-105 transition-all text-sm ${loader && "px-8 py-2.5 transition-all"}`}
    onClick={(e) => {
      funcao(e, produto);
    }}
  >
