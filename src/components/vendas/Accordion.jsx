...
const Accordion = ({ titulo, children }) => {
  ...
  return (
    <div className="w-full py-3 shadow-md border-b rounded-b-md z-20">
      <button
        onClick={() => setToggle((toggle) => !toggle)}
        className={`w-full gap-3 flex items-center relative`}
      >
      ...
      <div className={`transition-all duration-300 ease-in-out flex justify-center items-center ${toggle ? `opacity-100 h-[70vh] flex` : `h-0 opacity-0 hidden`}`}>
