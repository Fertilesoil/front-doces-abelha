...
const CardRecheio = ({ id, nome, caminho }) => {
  ...
  return (
    <div className="flex flex-col justify-center items-center gap-3 ring ring-pink-200 rounded-md bg-pink-50 w-[22rem] min-h-[8rem] font-ManRope">
      <div className="flex items-center justify-center gap-2 w-[100%]">
        ...
        <h3 className="whitespace-nowrap overflow-hidden text-center font-[600] text-slate-600 leading-4">
          {id}
        </h3>
      </div>
